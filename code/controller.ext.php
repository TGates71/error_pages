...
// module specific static functions
    ...
    static function getOpenEditor() {
		...
		if ($controller->GetAllControllerRequests('FORM')) {
			...
			$theEditor = '
			<iframe src="./modules/' . $controller->GetControllerRequest('URL', 'module') . '/code/editor.php?domain=' . $domain . '" name="ep_editor" width="100%" height="985" scrolling="auto" frameborder="0"></iframe>
			';

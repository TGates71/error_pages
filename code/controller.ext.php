...
// Module translation static functions - Not implemented yet	
    ...
    static function getCopyright()
	{
        ...
        $copyright = '<font face="ariel" size="2">' . ui_module::GetModuleName() . ' v3.1.3 &copy; 2021-' . date("Y") . ' by <a target="_blank" href="#">TGates</a> for <a target="_blank" href="http://sentora.org">Sentora Control Panel</a>&nbsp;&#8212;&nbsp;' . ui_language::translate("Help support future development of this module and donate today!") . '</font> ';
